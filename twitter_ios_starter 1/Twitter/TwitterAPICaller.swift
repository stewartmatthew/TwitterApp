...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "UikjIsdRFRODRrzHcpjmi9Lru", consumerSecret: "bZnIHQrA5z4IjgxwFQUBZ83H7hg8qMGFbFeq4MEHZdTmJE8TBx")
    var loginSuccess: (() -> ())?
